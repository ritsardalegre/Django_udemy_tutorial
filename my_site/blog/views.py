...
class StartingPage(ListView):
    template_name = "blog/index.html" #return render(request, "blog/index.html",  #"posts": latest_posts
    model = Post # Same with == latest_posts = Post.objects.all().order_by("-date")[:3]
    ordering = ["-date"]
